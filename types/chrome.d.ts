...
declare namespace chrome {
  ...
  export namespace cookies {
     ...
     * @since Chrome 132
     */
    export function getPartitionKey(details: FrameDetails): Promise<{
      /**
       * The partition key for reading or modifying cookies with the Partitioned attribute.
       */
      partitionKey: CookiePartitionKey;
  ...
  export namespace documentScan {
    ...
    export function openScanner(
      ...
      callback?: (response: OpenScannerResponse) => void,
    ): void;
    ...
    export function getOptionGroups(
      ...
      callback?: (response: GetOptionGroupsResponse) => void,
    ): void;
    ...
    export function closeScanner(
      ...
      callback?: (response: CloseScannerResponse) => void,
    ): void;
    ...
    export function setOptions(
      ...
      callback?: (response: SetOptionsResponse) => void,
    ): void;
    ...
    export function startScan(
      ...
      callback?: (response: StartScanResponse) => void,
    ): void;
     ...
     * @since Chrome 125
     */
    export function cancelScan(job: string): Promise<CancelScanResponse>;
    ...
    export function cancelScan(
      ...
      callback?: (response: CancelScanResponse) => void,
    ): void;
     ...
     * @since Chrome 125
     */
    export function readScanData(job: string): Promise<ReadScanDataResponse>;
    ...
    export function readScanData(
      ...
      callback?: (response: ReadScanDataResponse) => void,
    ): void;
  }
  ...
  export namespace input.ime {
     ...
     */
    export function setComposition(parameters: {
      /**
     ...
     * @returns Resolves when the operation completes with a boolean indicating if the text was accepted or not. On failure, the promise will be rejected.
     */
    export function clearComposition(parameters: {
      /**
     ...
     * @returns Resolves when the operation completes with a boolean indicating if the text was accepted or not. On failure, the promise will be rejected.
     */
    export function commitText(parameters: {
      /**
     ...
     */
    export function sendKeyEvents(parameters: {
      /**
     ...
     * @returns Resolves when the operation completes.
     */
    export function setCandidateWindowProperties(parameters: {
      /**
     ...
     * @returns Resolves when the operation completes.
     */
    export function setCandidates(parameters: {
      /**
     ...
     * @returns Resolves when the operation completes
     */
    export function setCursorPosition(parameters: {
      /**
       * ID of the context that owns the candidate window.
       */
      contextID: number;
     ...
     * @returns Resolves when the operation completes.
     */
    export function deleteSurroundingText(parameters: {
      /**
  ...
  export namespace mimeHandler {
    ...
    export function getMimeHandlerOptions(
      ...
      callback?: (options: MimeHandlerOptions) => void,
    ): void;
  }
  ...
  export namespace pageCapture {
     ...
     */
    export function saveAsMHTML(details: {
      /**
  ...
  export namespace permissions {
     ...
     * @chrome-min-manifest MV3
     */
    export function addHostAccessRequest(request: {
      /**
     ...
     * @chrome-min-manifest MV3
     */
    export function removeHostAccessRequest(request: {
      /**
  ...
  export namespace privacy {
     ...
     * @since Chrome 151
     */
    export type AutofillBlockedType =
      | "contact_info"
      | "payments"
      | "identity_docs"
      | "travel"
  ...
  export namespace sockets.tcp {
     ...
     */
    export function create(properties?: SocketProperties): Promise<CreateInfo>;
     ...
     */
    export function disconnect(socketId: number): Promise<void>;
     ...
     */
    export function close(socketId: number): Promise<void>;
  ...
  export namespace sockets.udp {
     ...
     */
    export function getJoinedGroups(socketId: number): Promise<string[]>;
  ...
  export namespace ttsEngine {
     ...
     * @since Chrome 132
     */
    export type LanguageInstallStatus =
      | "notInstalled"
      | "installing"
      | "installed"
      | "failed";
